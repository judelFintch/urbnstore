                                    ...
                                    <div>
                                        ...
                                        <div class="row">
                                            @foreach ($pictures as $picture)
                                                ...
                                                <div class="col-md-4">
                                                    <div class="relative border rounded-lg overflow-hidden shadow-md hover:scale-105 transition-transform duration-300">
                                                        <!-- Image -->
                                                        ...
                                                        <button wire:click="deletePhoto({{ $picture->id }})"
                                                            class="absolute top-2 right-2 bg-red-600 hover:bg-red-800 text-white p-2 rounded-full shadow-md transition-all duration-300"
