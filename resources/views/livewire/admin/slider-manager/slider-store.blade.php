                                        ...
                                        @if ($isEditing || $sliderId === null)
                                            <form wire:submit.prevent="save" class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    @error('caption') <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                    ...
                                                    @foreach ($slidersPaginated as $slider)
                                                        <tr>
                                                            ...
                                                            <td><a href="{{ $slider->link }}"
                                                                    target="_blank">{{ $slider->link }}</a></td>
                                                            <td>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            @if ($sliderToDelete)
                                                                <p>Êtes-vous sûr de vouloir supprimer le slider suivant ?</p>
                                                                <ul>
                                                                    <li><strong>Nom :</strong> {{ $sliderToDelete->name }}</li>
                                                                    <li><strong>Légende :</strong>
                                                                        {{ $sliderToDelete->caption }}</li>
                                                                </ul>
                                                            @else
                                                                <p>Les informations du slider n'ont pas pu être récupérées.</p>
                                                            @endif
                                                        </div>
