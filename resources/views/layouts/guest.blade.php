...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('fonts/linearicons-v1.0.0/icon-font.min.css') }}?v={{ filemtime(public_path('fonts/linearicons-v1.0.0/icon-font.min.css')) }}">
    <link rel="stylesheet" href="{{ asset('vendor/animate/animate.css') }}?v={{ filemtime(public_path('vendor/animate/animate.css')) }}">
    <link rel="stylesheet" href="{{ asset('vendor/css-hamburgers/hamburgers.min.css') }}?v={{ filemtime(public_path('vendor/css-hamburgers/hamburgers.min.css')) }}">
    <link rel="stylesheet" href="{{ asset('vendor/animsition/css/animsition.min.css') }}?v={{ filemtime(public_path('vendor/animsition/css/animsition.min.css')) }}">
    <link rel="stylesheet" href="{{ asset('vendor/select2/select2.min.css') }}?v={{ filemtime(public_path('vendor/select2/select2.min.css')) }}">
    ...
    <link rel="stylesheet" href="{{ asset('vendor/MagnificPopup/magnific-popup.css') }}?v={{ filemtime(public_path('vendor/MagnificPopup/magnific-popup.css')) }}">
    <link rel="stylesheet" href="{{ asset('vendor/perfect-scrollbar/perfect-scrollbar.css') }}?v={{ filemtime(public_path('vendor/perfect-scrollbar/perfect-scrollbar.css')) }}">
...
<body class="animsition">
    ...
    <script src="{{ asset('vendor/select2/select2.min.js') }}?v={{ filemtime(public_path('vendor/select2/select2.min.js')) }}" defer></script>
    <script src="{{ asset('vendor/daterangepicker/moment.min.js') }}?v={{ filemtime(public_path('vendor/daterangepicker/moment.min.js')) }}" defer></script>
    <script src="{{ asset('vendor/daterangepicker/daterangepicker.js') }}?v={{ filemtime(public_path('vendor/daterangepicker/daterangepicker.js')) }}" defer></script>
    <script src="{{ asset('vendor/slick/slick.min.js') }}?v={{ filemtime(public_path('vendor/slick/slick.min.js')) }}" defer></script>
    <script src="{{ asset('vendor/parallax100/parallax100.js') }}?v={{ filemtime(public_path('vendor/parallax100/parallax100.js')) }}" defer></script>
    <script src="{{ asset('vendor/MagnificPopup/jquery.magnific-popup.min.js') }}?v={{ filemtime(public_path('vendor/MagnificPopup/jquery.magnific-popup.min.js')) }}" defer></script>
    <script src="{{ asset('vendor/isotope/isotope.pkgd.min.js') }}?v={{ filemtime(public_path('vendor/isotope/isotope.pkgd.min.js')) }}" defer></script>
    ...
    <script src="{{ asset('vendor/perfect-scrollbar/perfect-scrollbar.min.js') }}?v={{ filemtime(public_path('vendor/perfect-scrollbar/perfect-scrollbar.min.js')) }}" defer></script>
